...
public class Program {
 ...
 //   private static final int WIN_COUNT = 4; // Выигрышная комбинация
    private static char DOT_HUMAN; // Фишка игрока - человек
    private static char DOT_AI; // Фишка игрока - компьютер
    ...
    public static void main(String[] args) {
        //реализация запроса размера игрового поля у пользователя
        System.out.println("Привет. Для начала игры необходимо задать размеры поля. \n Введи числа через пробел: ");
    ...
    private static void whoFirst(){
        ...
        if(result == 1){
            System.out.println("Первым ходит компьютер. Выбери фишку: ");
            chooseSymbol();
        }
        else {
            System.out.println("Первым ходит компьютер. Выбери фишку: X или O ");
    ...
    //выбор фишки для компьютера
    public static void chooseSymbol(){
      DOT_AI =  random.nextInt(2) == 1 ? 'X' : 'O';
    }
